...
/**
 * Repesents the MinChat version an artifact was built for.
 *
 ...
 * from the build version of the client, it should not try to
...
data class BuildVersion(
	...
	fun isInterchangableWith(other: BuildVersion) =
